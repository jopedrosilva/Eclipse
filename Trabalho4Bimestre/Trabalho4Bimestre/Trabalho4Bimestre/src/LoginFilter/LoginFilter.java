...
public class LoginFilter implements Filter {
	 ...
	 * */
	//TODO: incluir URLs que podem ser acessadas sem estar logado
	//Se essas páginas estiverem dentro de uma pasta chamada "publico", não precisa incluir aqui
	private final String[] urlsPermitidas = {"login.xhtml", "inicio1.xhtml", "cadastroUsuario.xhtml"};
	...
	public void doFilter(ServletRequest req, ServletResponse res,
        ...
        //Indica se o acesso será permitido ou não. Por padrão, não é permitido. 
   		...
   		deve ser permitido */
   		//TODO: Mudar o nome do projeto
   		if (reqUrl.contains("/publico/") || reqUrl.equals("/Trabalho4Bimestre/") 
        ...
        if (session.getAttribute("usuarioLogado") != null || permitido) {
        	...
        	//TODO: mudar nome do projeto e mudar para página de login
        	response.sendRedirect("/Trabalho4Bimestre/login.xhtml");
            return;
        }
